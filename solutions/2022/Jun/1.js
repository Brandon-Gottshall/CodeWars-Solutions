...
const recoverSecret = function(triplets1) {
  ...
  console.log(scrambled)
  let iterations = 0
  return unscramble(scrambled, triplets1=triplets1, iterations=iterations)
}

const unscramble = function(scrambled, triplets1, iterations) {
  let repeat = false
  ...
  console.log(repeat)
  return repeat ? unscramble(scrambled, triplets1, iterations) : scrambled.join('')
}

// Final Refactor

// const recoverSecret = function(triplets1) {
//   let scrambled = Array.from(new Set(triplets1.flat()))
//   return unscramble(scrambled, triplets)
// }

// const unscramble = function(scrambled, triplets) {
//   let repeat = false
//   triplets.every(triplet => {
//     if (scrambled.indexOf(triplet[2]) < scrambled.indexOf(triplet[1])) { 
//       scrambled.splice(scrambled.indexOf(triplet[1]) + 1, 0, triplet[2])
//       if (scrambled.indexOf(triplet[2]) !== scrambled.lastIndexOf(triplet[2])) {
//         scrambled.splice(scrambled.indexOf(triplet[2]), 1)
...
//     return true
//   })
//   return repeat ? unscramble(scrambled, triplets) : scrambled.join('')
// }
